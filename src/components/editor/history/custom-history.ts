...
type ChangeType = 0 | 1 | 2 | 3 | 4 | 5;
const OTHER = 0;
const COMPOSING_CHARACTER = 1;
const INSERT_CHARACTER_AFTER_SELECTION = 2;
const DELETE_CHARACTER_BEFORE_SELECTION = 3;
const DELETE_CHARACTER_AFTER_SELECTION = 4;
const ADD_AUTOCOMPLETE_NODE = 5;
...
function isAutocompleteNode(node: LexicalNode): boolean {
  return node.getType() === 'autocomplete' || node.__type === 'autocomplete';
}
...
function getDirtyNodes(
  ...
  console.log("history dirtyNodes", nodes)
...
function getChangeType(
  ...
  if (dirtyNodes.length > 1) {
    ...
    if (nextAnchorNode && prevAnchorNode && nextAnchorNode.__type === 'autocomplete') {
      return ADD_AUTOCOMPLETE_NODE;
    }
...
function redo(editor: LexicalEditor, historyState: HistoryState): void {
  ...
  console.log("history redo", historyState)
}
...
function undo(editor: LexicalEditor, historyState: HistoryState): void {
  ...
  console.log("history undo", historyState)
}
